<template>
  <div>
    ...
    >
      ...
      <div class="relative bg-white w-8/12 p-2 h-full overflow-auto">
        <div class="flex items-center p-2 justify-between">
          <h1 class="text-xl text-gray-900 font-roboto font-bold">FOSBlog</h1>

          <button
            class="text-gray-900 rounded-lg p-2 hover:bg-gray-200"
            @click="toggle"
          >
            <svg
        ...
        <div class="p-1">
          <ul>
            <li>
              <a
                href="/"
                class="flex items-center p-1.5 text-gray-900 hover:bg-blue-100 rounded hover:text-blue-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 44 44"
                ...
                <span class="text-base font-roboto ml-2">Home</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="text-base font-roboto ml-2">Tags</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="text-base font-roboto ml-2">FAQ</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="p-1 mt-5">
          <span class="text-lg text-gray-900 font-roboto font-semibold ml-1"
            >Other</span
          >
          <ul>
            <li>
              ...
              >
                ...
                <span class="text-base font-roboto ml-2">Code of Conduct</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="text-base font-roboto ml-2">Privacy Policy</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="text-base font-roboto ml-2">Terms of use</span>
              </a>
            </li>
          </ul>
        </div>

        <div class="-ml-1 mt-5 flex items-center justify-around">
          <a href="#" class="group p-2 rounded-md hover:bg-blue-100">
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="af5wbhkb2zmh0jpmb35w7vuov4rwzzbe"
              class="fill-grey-700 group-hover:fill-blue-600"
            >
              <title id="af5wbhkb2zmh0jpmb35w7vuov4rwzzbe">Twitter</title>
              <path
          ...
          <a href="#" class="group p-2 rounded-md hover:bg-blue-100">
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="aebb0e3w75p1r2hi9li0dxvkehtn0w3k"
              class="fill-grey-700 group-hover:fill-blue-600"
            >
              <title id="aebb0e3w75p1r2hi9li0dxvkehtn0w3k">Facebook</title>
              <path
          ...
          <a href="#" class="group p-2 rounded-md hover:bg-blue-100">
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="ag39jtlbjf2fmusjp0w2clx7petduojo"
              class="fill-grey-700 group-hover:fill-blue-600"
            >
              <title id="ag39jtlbjf2fmusjp0w2clx7petduojo">Github</title>
              <path
          ...
          <a href="#" class="group p-2 rounded-md hover:bg-blue-100">
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="a66pokcqxlxyttmx4abc36fogdrqkv7s"
              class="fill-grey-700 group-hover:fill-blue-600"
            >
              <title id="a66pokcqxlxyttmx4abc36fogdrqkv7s">Instagram</title>
              <path
          ...
          <a href="#" class="group p-2 rounded-md hover:bg-blue-100">
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="ao2kznfbxnt4e6fvvlkg8cty4l8yfp0"
              class="fill-grey-700 group-hover:fill-blue-600"
            >
              <title id="ao2kznfbxnt4e6fvvlkg8cty4l8yfp0">Twitch</title>
              <path
